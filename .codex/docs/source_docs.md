...
- `docs/archive/agents-implementation/README.md:1` and `docs/archive/ROADMAP.spec.md:1` as representative entrypoints into the historical spec set. Use archive docs only when current code or current architecture docs point you there for subsystem history.
