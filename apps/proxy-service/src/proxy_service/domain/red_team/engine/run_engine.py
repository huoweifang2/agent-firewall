...
from proxy_service.domain.red_team.engine.protocols import (
    HttpClientProtocol,
    HttpResponse,
    NormalizerProtocol,
    PersistenceProtocol,
...
from proxy_service.domain.red_team.evaluators import evaluate_scenario
from proxy_service.domain.red_team.packs import FilteredPack, TargetConfig, filter_pack, load_pack
from proxy_service.domain.red_team.schemas import Scenario
from proxy_service.domain.red_team.schemas.dataclasses import EvalResult
from proxy_service.domain.red_team.schemas.enums import ExpectedAction, ScenarioStage
from proxy_service.domain.red_team.scoring import ScenarioOutcome, ScenarioResult, ScoreResult, compute_scores
