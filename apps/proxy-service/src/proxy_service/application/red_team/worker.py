...
from proxy_service.domain.red_team.engine.run_engine import BenchmarkRun, RunConfig, RunEngine, RunState
from proxy_service.domain.red_team.packs import TargetConfig, filter_pack, load_pack
from proxy_service.infrastructure.red_team.adapters import (
...
async def _execute(
    ...
    if auth_ref:
        try:
            ...
            from proxy_service.domain.red_team.secrets.store import EncryptedColumnSecretStore
