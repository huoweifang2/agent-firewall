...
if TYPE_CHECKING:
    from proxy_service.domain.control_plane.models import AgentRole, AgentTool, RoleToolPermission
...
async def detect_circular_inheritance(
    ...
    from proxy_service.domain.control_plane.models import AgentRole  # noqa: F811
