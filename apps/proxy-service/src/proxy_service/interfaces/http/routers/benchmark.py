...
from proxy_service.application.red_team.worker import run_benchmark_background
from proxy_service.domain.red_team.net import rewrite_localhost_for_docker, validate_url
from proxy_service.domain.red_team.packs import load_pack
...
from proxy_service.interfaces.http.schemas.benchmark import (
    CompareResponse,
    CreateRunRequest,
    ErrorResponse,
    ExportRunRequest,
...
async def create_run(
    ...
    from proxy_service.domain.red_team.engine.run_engine import ConcurrencyConflictError
    ...
    try:
        ...
        if content_type and "json" in content_type:
            try:
                ...
                from proxy_service.domain.red_team.engine.json_text_extractor import detect_text_paths
