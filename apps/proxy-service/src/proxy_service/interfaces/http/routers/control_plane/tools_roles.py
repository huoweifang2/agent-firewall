...
from proxy_service.application.control_plane.openclaw import openclaw_arg_schema, openclaw_tool_name
from proxy_service.application.control_plane.permissions import (
...
async def create_tool(
    ...
    if explicit_rate_limit is not None:
        ...
        from proxy_service.domain.control_plane.models import AccessType, Sensitivity
...
async def update_tool(
    ...
    if "rate_limit" not in update_data and "sensitivity" in update_data:
        from proxy_service.domain.control_plane.models import RATE_LIMIT_DEFAULTS
