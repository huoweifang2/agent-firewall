...
from proxy_service.infrastructure.config import Settings, get_settings
from proxy_service.infrastructure.persistence.session import cache_mode, get_db, get_redis
from proxy_service.interfaces.http.schemas.health import (
    HealthResponse,
