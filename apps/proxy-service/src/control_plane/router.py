...
from src.wizard.routers.openclaw import router as openclaw_router
from src.wizard.routers.rollout import router as rollout_router
from src.wizard.routers.runtime import router as runtime_router
from src.wizard.routers.teams import router as teams_router
...
wizard_router.include_router(openclaw_router)
...
wizard_router.include_router(runtime_router)
wizard_router.include_router(teams_router)
