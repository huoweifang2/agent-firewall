...
\setCJKfamilyfont{zhkai}[
  BoldFont={STKaitiSC-Bold},
  ItalicFont={STKaitiSC-Regular},
  BoldItalicFont={STKaitiSC-Bold}
]{STKaitiSC-Regular}
\newcommand{\songti}{\CJKfamily{zhsong}}
\newcommand{\heiti}{\CJKfamily{zhhei}}
\newcommand{\kaitifont}{\CJKfamily{zhkai}}
...
\DeclareCaptionLabelFormat{thesis}{{\xeCJKsetup{CJKecglue={}}#1#2}}
\captionsetup[figure]{labelformat=thesis}
\captionsetup[table]{labelformat=thesis}

\graphicspath{{figures/autofigure/pdf/}{figures/}}

\renewcommand{\cftsecleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cfttoctitlefont}{\hfill\zihao{3}\bfseries\songti}
\renewcommand{\cftaftertoctitle}{\hfill}
\renewcommand{\cftbeforetoctitleskip}{0.5\baselineskip}
...
\renewcommand{\cftsecpagefont}{\zihao{5}\songti}
\renewcommand{\cftsubsecpagefont}{\zihao{5}\songti}
\renewcommand{\cftsubsubsecpagefont}{\zihao{5}\songti}
...
\setlist[enumerate]{topsep=3pt,itemsep=2pt,parsep=0pt,partopsep=0pt,leftmargin=0pt,labelindent=2\ccwd,itemindent=0pt,labelsep=0pt,listparindent=2\ccwd}
\urlstyle{tt}
...
\newenvironment{cnabstract}{\kaitifont}{\par}
\newenvironment{enabstract}{\rmfamily}{\par}
\newcommand{\keywordspace}{\vspace{1\baselineskip}\noindent}
  ...
  {\section*{\refname}%
   ...
   \list{\@biblabel{\@arabic\c@enumiv}}%
     {\settowidth\labelwidth{\@biblabel{#1}}%
      \leftmargin=2.02\ccwd
      \itemindent=-2.02\ccwd
      \labelsep=0.5\ccwd
      \itemsep=0pt
      \parsep=0pt
      \usecounter{enumiv}%
...
\keywordspace\textbf{关键词：}智能体安全，工具调用，提示词注入，RBAC，OpenClaw
...
\keywordspace\textbf{Keywords:} AI agent security, tool calling, prompt injection, RBAC, OpenClaw
